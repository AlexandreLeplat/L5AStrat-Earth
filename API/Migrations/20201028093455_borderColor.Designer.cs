...
namespace HostApp.Migrations
{
    ...
    [Migration("20201028093455_borderColor")]
    partial class borderColor
    {
            ...
            modelBuilder.Entity("Entities.Models.ActionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            GameId = 1L,
                            Label = "Flatterie",
                            _jsonForm = "[{\"Label\":\"Cible\",\"Type\":\"Opponent\",\"Description\":\"L\\u0027adversaire recevant 2 points de Gloire\",\"Parameter\":null},{\"Label\":\"Augmentation\",\"Type\":\"Checkbox\",\"Description\":\"Faveur politique : D\\u00E9pensez un point d\\u2019Influence pour gagner 4 points de Gloire suppl\\u00E9mentaires et ne cibler personne\",\"Parameter\":null}]"
                        },
                        new
                        {
                            Id = 3L,
                            ...
                            GameId = 1L,
                            Label = "Médisance",
                            _jsonForm = "[{\"Label\":\"Cible\",\"Type\":\"Opponent\",\"Description\":\"L\\u0027adversaire subissant la m\\u00E9disance\",\"Parameter\":null},{\"Label\":\"Augmentation\",\"Type\":\"Checkbox\",\"Description\":\"Scandale : D\\u00E9pensez un point d\\u2019Influence pour ajouter 3 points d\\u2019Infamie \\u00E0 votre cible et remplacer votre gain d\\u0027Infamie par un gain de Gloire.\",\"Parameter\":null}]"
                        },
                        new
                        {
                            Id = 4L,
            ...
            modelBuilder.Entity("Entities.Models.Campaign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NextPhase = new DateTime(2020, 10, 28, 22, 34, 54, 171, DateTimeKind.Local).AddTicks(4),
                            PhaseLength = 720,
                            Status = 2,
            ...
            modelBuilder.Entity("Entities.Models.Map", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CampaignId = 1L,
                            CreationDate = new DateTime(2020, 10, 28, 10, 34, 54, 186, DateTimeKind.Local).AddTicks(9687),
