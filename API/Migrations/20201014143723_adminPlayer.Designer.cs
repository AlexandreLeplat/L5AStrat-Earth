...
namespace HostApp.Migrations
{
    ...
    [Migration("20201014143723_adminPlayer")]
    partial class adminPlayer
    {
            ...
            modelBuilder.Entity("Entities.Models.Campaign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NextPhase = new DateTime(2020, 10, 15, 16, 37, 22, 656, DateTimeKind.Local).AddTicks(3703),
                            PhaseLength = 24,
                            Status = 2,
            ...
            modelBuilder.Entity("Entities.Models.Map", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CampaignId = 1L,
                            CreationDate = new DateTime(2020, 10, 14, 16, 37, 22, 675, DateTimeKind.Local).AddTicks(728),
