...
namespace HostApp.Migrations
{
    ...
    [Migration("20201006203519_messages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Campaign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NextPhase = new DateTime(2020, 10, 7, 22, 35, 18, 752, DateTimeKind.Local).AddTicks(1109),
                            PhaseLength = 24,
                            Status = 2,
            ...
            modelBuilder.Entity("Entities.Models.Map", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CampaignId = 1L,
                            CreationDate = new DateTime(2020, 10, 6, 22, 35, 18, 768, DateTimeKind.Local).AddTicks(3297),
            ...
            modelBuilder.Entity("Entities.Models.Unit", b =>
                {
                    b.HasOne("Entities.Models.MapTile", "MapTile")
                        .WithMany()
